PROJECT_NAME := Pulumi Constellix Resource Provider

SHELL = /bin/bash

PACK             := constellix
PACKDIR          := sdk
PROJECT          := github.com/cloudy-sky-software/pulumi-constellix
NODE_MODULE_NAME := @cloudyskysoftware/pulumi-constellix
NUGET_PKG_NAME   := Pulumi.Constellix
...
SCHEMA_FILE     := provider/cmd/pulumi-resource-constellix/schema.json
