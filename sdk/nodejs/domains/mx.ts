...
export class Mx extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'constellix:domains:Mx';
     ...
     */
    public readonly mode!: pulumi.Output<enums.domains.MxPropertiesMode | undefined>;
    /**
     ...
     * The type of record
     */
    public readonly type!: pulumi.Output<enums.domains.MxPropertiesType | undefined>;
    /**
     * Standard record mode
     */
    public readonly value!: pulumi.Output<outputs.domains.ValueMxValueItemProperties[] | undefined>;
...
export interface MxArgs {
     ...
     * The current mode for this record
     */
    mode?: pulumi.Input<enums.domains.MxPropertiesMode>;
    /**
     * The name for the record
     */
     ...
     * The type of record
     */
    type?: pulumi.Input<enums.domains.MxPropertiesType>;
    /**
     * Standard record mode
     */
    value?: pulumi.Input<pulumi.Input<inputs.domains.ValueMxValueItemPropertiesArgs>[]>;
}
