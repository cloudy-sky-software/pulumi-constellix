...
export class Spf extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'constellix:domains:Spf';
     ...
     */
    public readonly mode!: pulumi.Output<enums.domains.SpfPropertiesMode | undefined>;
    /**
     ...
     * The type of record
     */
    public readonly type!: pulumi.Output<enums.domains.SpfPropertiesType | undefined>;
    /**
     * Standard record mode
     */
    public readonly value!: pulumi.Output<outputs.domains.ValueSpfValueItemProperties[] | undefined>;
...
export interface SpfArgs {
     ...
     * The current mode for this record
     */
    mode?: pulumi.Input<enums.domains.SpfPropertiesMode>;
    /**
     * The name for the record
     */
     ...
     * The type of record
     */
    type?: pulumi.Input<enums.domains.SpfPropertiesType>;
    /**
     * Standard record mode
     */
    value?: pulumi.Input<pulumi.Input<inputs.domains.ValueSpfValueItemPropertiesArgs>[]>;
}
