...
export class Txt extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'constellix:domains:Txt';
     ...
     */
    public readonly mode!: pulumi.Output<enums.domains.TxtPropertiesMode | undefined>;
    /**
     ...
     * The type of record
     */
    public readonly type!: pulumi.Output<enums.domains.TxtPropertiesType | undefined>;
    /**
     * Standard record mode
     */
    public readonly value!: pulumi.Output<outputs.domains.ValueTxtValueItemProperties[] | undefined>;
...
export interface TxtArgs {
     ...
     * The current mode for this record
     */
    mode?: pulumi.Input<enums.domains.TxtPropertiesMode>;
    /**
     * The name for the record
     */
     ...
     * The type of record
     */
    type?: pulumi.Input<enums.domains.TxtPropertiesType>;
    /**
     * Standard record mode
     */
    value?: pulumi.Input<pulumi.Input<inputs.domains.ValueTxtValueItemPropertiesArgs>[]>;
}
