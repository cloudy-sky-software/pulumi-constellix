...
export class DomainRecord extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): DomainRecord {
        return new DomainRecord(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'constellix:domains:DomainRecord';
     ...
     */
    public readonly region!: pulumi.Output<enums.domains.DomainRecordPropertiesRegion | undefined>;
    /**
...
export interface DomainRecordArgs {
     ...
     * Optional region for this record. Will default to 'default'.
     */
    region?: pulumi.Input<enums.domains.DomainRecordPropertiesRegion>;
    /**
     * Only used on POST or PATCH requests for ANAME records, used to specify whether the hostname should be looked up immediately. Will be null otherwise.
     */
