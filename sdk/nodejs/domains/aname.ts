...
export class Aname extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'constellix:domains:Aname';
     ...
     */
    public readonly mode!: pulumi.Output<enums.domains.AnamePropertiesMode | undefined>;
    /**
     ...
     * The type of record
     */
    public readonly type!: pulumi.Output<enums.domains.AnamePropertiesType | undefined>;
    public readonly value!: pulumi.Output<outputs.domains.ValueAnameRequestValueItemProperties[] | outputs.domains.ValueAnameRequestValueProperties | outputs.domains.ValueAnameRequestValueItemProperties[] | undefined>;
...
export interface AnameArgs {
     ...
     * The current mode for this record
     */
    mode?: pulumi.Input<enums.domains.AnamePropertiesMode>;
    /**
     * The name for the record
     */
     ...
     * The type of record
     */
    type?: pulumi.Input<enums.domains.AnamePropertiesType>;
    value?: pulumi.Input<pulumi.Input<inputs.domains.ValueAnameRequestValueItemPropertiesArgs>[] | inputs.domains.ValueAnameRequestValuePropertiesArgs | pulumi.Input<inputs.domains.ValueAnameRequestValueItemPropertiesArgs>[]>;
}
