...
export class A extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'constellix:domains:A';
     ...
     */
    public readonly mode!: pulumi.Output<enums.domains.APropertiesMode | undefined>;
    /**
     ...
     * The type of record
     */
    public readonly type!: pulumi.Output<enums.domains.APropertiesType | undefined>;
    public readonly value!: pulumi.Output<outputs.domains.ValueARequestValueItemProperties[] | outputs.domains.ValueARequestValueProperties | outputs.domains.ValueARequestValueItemProperties[] | outputs.domains.ValueARequestValueItemProperties[] | undefined>;
...
export interface AArgs {
     ...
     * The current mode for this record
     */
    mode?: pulumi.Input<enums.domains.APropertiesMode>;
    /**
     * The name for the record
     */
     ...
     * The type of record
     */
    type?: pulumi.Input<enums.domains.APropertiesType>;
    value?: pulumi.Input<pulumi.Input<inputs.domains.ValueARequestValueItemPropertiesArgs>[] | inputs.domains.ValueARequestValuePropertiesArgs | pulumi.Input<inputs.domains.ValueARequestValueItemPropertiesArgs>[] | pulumi.Input<inputs.domains.ValueARequestValueItemPropertiesArgs>[]>;
}
