...
export class Cname extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'constellix:domains:Cname';
     ...
     */
    public readonly mode!: pulumi.Output<enums.domains.CnamePropertiesMode | undefined>;
    /**
     ...
     * The type of record
     */
    public readonly type!: pulumi.Output<enums.domains.CnamePropertiesType | undefined>;
    public readonly value!: pulumi.Output<outputs.domains.ValueCnameRequestValueItemProperties[] | outputs.domains.ValueCnameRequestValueProperties | outputs.domains.ValueCnameRequestValueItemProperties[] | undefined>;
...
export interface CnameArgs {
     ...
     * The current mode for this record
     */
    mode?: pulumi.Input<enums.domains.CnamePropertiesMode>;
    /**
     * The name for the record
     */
     ...
     * The type of record
     */
    type?: pulumi.Input<enums.domains.CnamePropertiesType>;
    value?: pulumi.Input<pulumi.Input<inputs.domains.ValueCnameRequestValueItemPropertiesArgs>[] | inputs.domains.ValueCnameRequestValuePropertiesArgs | pulumi.Input<inputs.domains.ValueCnameRequestValueItemPropertiesArgs>[]>;
}
