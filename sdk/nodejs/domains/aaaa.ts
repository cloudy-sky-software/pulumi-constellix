...
export class Aaaa extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'constellix:domains:Aaaa';
     ...
     */
    public readonly mode!: pulumi.Output<enums.domains.AaaaPropertiesMode | undefined>;
    /**
     ...
     * The type of record
     */
    public readonly type!: pulumi.Output<enums.domains.AaaaPropertiesType | undefined>;
    public readonly value!: pulumi.Output<outputs.domains.ValueAaaaRequestValueItemProperties[] | outputs.domains.ValueAaaaRequestValueProperties | outputs.domains.ValueAaaaRequestValueItemProperties[] | outputs.domains.ValueAaaaRequestValueItemProperties[] | undefined>;
...
export interface AaaaArgs {
     ...
     * The current mode for this record
     */
    mode?: pulumi.Input<enums.domains.AaaaPropertiesMode>;
    /**
     * The name for the record
     */
     ...
     * The type of record
     */
    type?: pulumi.Input<enums.domains.AaaaPropertiesType>;
    value?: pulumi.Input<pulumi.Input<inputs.domains.ValueAaaaRequestValueItemPropertiesArgs>[] | inputs.domains.ValueAaaaRequestValuePropertiesArgs | pulumi.Input<inputs.domains.ValueAaaaRequestValueItemPropertiesArgs>[] | pulumi.Input<inputs.domains.ValueAaaaRequestValueItemPropertiesArgs>[]>;
}
