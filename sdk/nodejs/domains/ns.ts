...
export class Ns extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'constellix:domains:Ns';
     ...
     */
    public readonly mode!: pulumi.Output<enums.domains.NsPropertiesMode | undefined>;
    /**
     ...
     * The type of record
     */
    public readonly type!: pulumi.Output<enums.domains.NsPropertiesType | undefined>;
    /**
     * Standard record mode
     */
    public readonly value!: pulumi.Output<outputs.domains.ValueNsValueItemProperties[] | undefined>;
...
export interface NsArgs {
     ...
     * The current mode for this record
     */
    mode?: pulumi.Input<enums.domains.NsPropertiesMode>;
    /**
     * The name for the record
     */
     ...
     * The type of record
     */
    type?: pulumi.Input<enums.domains.NsPropertiesType>;
    /**
     * Standard record mode
     */
    value?: pulumi.Input<pulumi.Input<inputs.domains.ValueNsValueItemPropertiesArgs>[]>;
}
