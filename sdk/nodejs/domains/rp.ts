...
export class Rp extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'constellix:domains:Rp';
     ...
     */
    public readonly mode!: pulumi.Output<enums.domains.RpPropertiesMode | undefined>;
    /**
     ...
     * The type of record
     */
    public readonly type!: pulumi.Output<enums.domains.RpPropertiesType | undefined>;
    /**
     * Standard record mode
     */
    public readonly value!: pulumi.Output<outputs.domains.ValueRpValueItemProperties[] | undefined>;
...
export interface RpArgs {
     ...
     * The current mode for this record
     */
    mode?: pulumi.Input<enums.domains.RpPropertiesMode>;
    /**
     * The name for the record
     */
     ...
     * The type of record
     */
    type?: pulumi.Input<enums.domains.RpPropertiesType>;
    /**
     * Standard record mode
     */
    value?: pulumi.Input<pulumi.Input<inputs.domains.ValueRpValueItemPropertiesArgs>[]>;
}
