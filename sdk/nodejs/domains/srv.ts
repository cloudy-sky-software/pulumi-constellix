...
export class Srv extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'constellix:domains:Srv';
     ...
     */
    public readonly mode!: pulumi.Output<enums.domains.SrvPropertiesMode | undefined>;
    /**
     ...
     * The type of record
     */
    public readonly type!: pulumi.Output<enums.domains.SrvPropertiesType | undefined>;
    /**
     * Standard record mode
     */
    public readonly value!: pulumi.Output<outputs.domains.ValueSrvValueItemProperties[] | undefined>;
...
export interface SrvArgs {
     ...
     * The current mode for this record
     */
    mode?: pulumi.Input<enums.domains.SrvPropertiesMode>;
    /**
     * The name for the record
     */
     ...
     * The type of record
     */
    type?: pulumi.Input<enums.domains.SrvPropertiesType>;
    /**
     * Standard record mode
     */
    value?: pulumi.Input<pulumi.Input<inputs.domains.ValueSrvValueItemPropertiesArgs>[]>;
}
