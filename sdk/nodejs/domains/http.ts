...
export class Http extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'constellix:domains:Http';
     ...
     */
    public readonly mode!: pulumi.Output<enums.domains.HttpPropertiesMode | undefined>;
    /**
     ...
     * The type of record
     */
    public readonly type!: pulumi.Output<enums.domains.HttpPropertiesType | undefined>;
    public readonly value!: pulumi.Output<outputs.domains.ValueHttpValueProperties | undefined>;
...
export interface HttpArgs {
     ...
     * The current mode for this record
     */
    mode?: pulumi.Input<enums.domains.HttpPropertiesMode>;
    /**
     * The name for the record
     */
     ...
     * The type of record
     */
    type?: pulumi.Input<enums.domains.HttpPropertiesType>;
    value?: pulumi.Input<inputs.domains.ValueHttpValuePropertiesArgs>;
}
