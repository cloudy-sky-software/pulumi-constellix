...
export class Cert extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'constellix:domains:Cert';
     ...
     */
    public readonly mode!: pulumi.Output<enums.domains.CertPropertiesMode | undefined>;
    /**
     ...
     * The type of record
     */
    public readonly type!: pulumi.Output<enums.domains.CertPropertiesType | undefined>;
    /**
     * Standard record mode
     */
    public readonly value!: pulumi.Output<outputs.domains.ValueCertValueItemProperties[] | undefined>;
...
export interface CertArgs {
     ...
     * The current mode for this record
     */
    mode?: pulumi.Input<enums.domains.CertPropertiesMode>;
    /**
     * The name for the record
     */
     ...
     * The type of record
     */
    type?: pulumi.Input<enums.domains.CertPropertiesType>;
    /**
     * Standard record mode
     */
    value?: pulumi.Input<pulumi.Input<inputs.domains.ValueCertValueItemPropertiesArgs>[]>;
}
