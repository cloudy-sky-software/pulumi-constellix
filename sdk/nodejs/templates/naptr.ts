...
export class Naptr extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): Naptr {
        return new Naptr(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'constellix:templates:Naptr';

    /**
     * Returns true if the given object is an instance of Naptr.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is Naptr {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === Naptr.__pulumiType;
    }
     ...
     */
    public readonly mode!: pulumi.Output<enums.templates.NaptrPropertiesMode | undefined>;
    /**
     ...
     * The type of record
     */
    public readonly type!: pulumi.Output<enums.templates.NaptrPropertiesType | undefined>;
    /**
     * Standard record mode
     */
    public readonly value!: pulumi.Output<outputs.templates.ValueNaptrValueItemProperties[] | undefined>;
     ...
     */
    constructor(name: string, args?: NaptrArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        super(Naptr.__pulumiType, name, resourceInputs, opts);
    }
}
...
export interface NaptrArgs {
     ...
     * The current mode for this record
     */
    mode?: pulumi.Input<enums.templates.NaptrPropertiesMode>;
    /**
     * The name for the record
     */
     ...
     * The type of record
     */
    type?: pulumi.Input<enums.templates.NaptrPropertiesType>;
    /**
     * Standard record mode
     */
    value?: pulumi.Input<pulumi.Input<inputs.templates.ValueNaptrValueItemPropertiesArgs>[]>;
}
