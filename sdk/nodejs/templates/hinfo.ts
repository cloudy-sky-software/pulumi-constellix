...
export class Hinfo extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): Hinfo {
        return new Hinfo(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'constellix:templates:Hinfo';

    /**
     * Returns true if the given object is an instance of Hinfo.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is Hinfo {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === Hinfo.__pulumiType;
    }
     ...
     */
    public readonly mode!: pulumi.Output<enums.templates.HinfoPropertiesMode | undefined>;
    /**
     ...
     * The type of record
     */
    public readonly type!: pulumi.Output<enums.templates.HinfoPropertiesType | undefined>;
    /**
     * Standard record mode
     */
    public readonly value!: pulumi.Output<outputs.templates.ValueHinfoValueItemProperties[] | undefined>;
     ...
     */
    constructor(name: string, args?: HinfoArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        super(Hinfo.__pulumiType, name, resourceInputs, opts);
    }
}
...
export interface HinfoArgs {
     ...
     * The current mode for this record
     */
    mode?: pulumi.Input<enums.templates.HinfoPropertiesMode>;
    /**
     * The name for the record
     */
     ...
     * The type of record
     */
    type?: pulumi.Input<enums.templates.HinfoPropertiesType>;
    /**
     * Standard record mode
     */
    value?: pulumi.Input<pulumi.Input<inputs.templates.ValueHinfoValueItemPropertiesArgs>[]>;
}
