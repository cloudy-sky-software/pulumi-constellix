...
export class Txt extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'constellix:templates:Txt';
     ...
     */
    public readonly mode!: pulumi.Output<enums.templates.TxtPropertiesMode | undefined>;
    /**
     ...
     * The type of record
     */
    public readonly type!: pulumi.Output<enums.templates.TxtPropertiesType | undefined>;
    /**
     * Standard record mode
     */
    public readonly value!: pulumi.Output<outputs.templates.ValueTxtValueItemProperties[] | undefined>;
...
export interface TxtArgs {
     ...
     * The current mode for this record
     */
    mode?: pulumi.Input<enums.templates.TxtPropertiesMode>;
    /**
     * The name for the record
     */
     ...
     * The type of record
     */
    type?: pulumi.Input<enums.templates.TxtPropertiesType>;
    /**
     * Standard record mode
     */
    value?: pulumi.Input<pulumi.Input<inputs.templates.ValueTxtValueItemPropertiesArgs>[]>;
}
