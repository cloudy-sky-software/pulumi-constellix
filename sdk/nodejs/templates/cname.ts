...
export class Cname extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'constellix:templates:Cname';
     ...
     */
    public readonly mode!: pulumi.Output<enums.templates.CnamePropertiesMode | undefined>;
    /**
     ...
     * The type of record
     */
    public readonly type!: pulumi.Output<enums.templates.CnamePropertiesType | undefined>;
    public readonly value!: pulumi.Output<outputs.templates.ValueCnameRequestValueItemProperties[] | outputs.templates.ValueCnameRequestValueProperties | outputs.templates.ValueCnameRequestValueItemProperties[] | undefined>;
...
export interface CnameArgs {
     ...
     * The current mode for this record
     */
    mode?: pulumi.Input<enums.templates.CnamePropertiesMode>;
    /**
     * The name for the record
     */
     ...
     * The type of record
     */
    type?: pulumi.Input<enums.templates.CnamePropertiesType>;
    value?: pulumi.Input<pulumi.Input<inputs.templates.ValueCnameRequestValueItemPropertiesArgs>[] | inputs.templates.ValueCnameRequestValuePropertiesArgs | pulumi.Input<inputs.templates.ValueCnameRequestValueItemPropertiesArgs>[]>;
}
