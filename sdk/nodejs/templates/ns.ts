...
export class Ns extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): Ns {
        return new Ns(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'constellix:templates:Ns';

    /**
     * Returns true if the given object is an instance of Ns.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is Ns {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === Ns.__pulumiType;
    }
     ...
     */
    public readonly mode!: pulumi.Output<enums.templates.NsPropertiesMode | undefined>;
    /**
     ...
     * The type of record
     */
    public readonly type!: pulumi.Output<enums.templates.NsPropertiesType | undefined>;
    /**
     * Standard record mode
     */
    public readonly value!: pulumi.Output<outputs.templates.ValueNsValueItemProperties[] | undefined>;
     ...
     */
    constructor(name: string, args?: NsArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        super(Ns.__pulumiType, name, resourceInputs, opts);
    }
}
...
export interface NsArgs {
     ...
     * The current mode for this record
     */
    mode?: pulumi.Input<enums.templates.NsPropertiesMode>;
    /**
     * The name for the record
     */
     ...
     * The type of record
     */
    type?: pulumi.Input<enums.templates.NsPropertiesType>;
    /**
     * Standard record mode
     */
    value?: pulumi.Input<pulumi.Input<inputs.templates.ValueNsValueItemPropertiesArgs>[]>;
}
