...
export class Http extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): Http {
        return new Http(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'constellix:templates:Http';
    ...
    public static isInstance(obj: any): obj is Http {
        ...
        return obj['__pulumiType'] === Http.__pulumiType;
    }
     ...
     */
    public readonly mode!: pulumi.Output<enums.templates.HttpPropertiesMode | undefined>;
    /**
     ...
     * The type of record
     */
    public readonly type!: pulumi.Output<enums.templates.HttpPropertiesType | undefined>;
    public readonly value!: pulumi.Output<outputs.templates.ValueHttpValueProperties | undefined>;
    ...
    constructor(name: string, args?: HttpArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        super(Http.__pulumiType, name, resourceInputs, opts);
    }
}
...
export interface HttpArgs {
     ...
     * The current mode for this record
     */
    mode?: pulumi.Input<enums.templates.HttpPropertiesMode>;
    /**
     * The name for the record
     */
     ...
     * The type of record
     */
    type?: pulumi.Input<enums.templates.HttpPropertiesType>;
    value?: pulumi.Input<inputs.templates.ValueHttpValuePropertiesArgs>;
}
