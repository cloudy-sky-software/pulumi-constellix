...
export class Mx extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): Mx {
        return new Mx(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'constellix:templates:Mx';

    /**
     * Returns true if the given object is an instance of Mx.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is Mx {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === Mx.__pulumiType;
    }
     ...
     */
    public readonly mode!: pulumi.Output<enums.templates.MxPropertiesMode | undefined>;
    /**
     ...
     * The type of record
     */
    public readonly type!: pulumi.Output<enums.templates.MxPropertiesType | undefined>;
    /**
     * Standard record mode
     */
    public readonly value!: pulumi.Output<outputs.templates.ValueMxValueItemProperties[] | undefined>;
     ...
     */
    constructor(name: string, args?: MxArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        super(Mx.__pulumiType, name, resourceInputs, opts);
    }
}
...
export interface MxArgs {
     ...
     * The current mode for this record
     */
    mode?: pulumi.Input<enums.templates.MxPropertiesMode>;
    /**
     * The name for the record
     */
     ...
     * The type of record
     */
    type?: pulumi.Input<enums.templates.MxPropertiesType>;
    /**
     * Standard record mode
     */
    value?: pulumi.Input<pulumi.Input<inputs.templates.ValueMxValueItemPropertiesArgs>[]>;
}
