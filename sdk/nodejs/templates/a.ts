...
export class A extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'constellix:templates:A';
     ...
     */
    public readonly mode!: pulumi.Output<enums.templates.APropertiesMode | undefined>;
    /**
     ...
     * The type of record
     */
    public readonly type!: pulumi.Output<enums.templates.APropertiesType | undefined>;
    public readonly value!: pulumi.Output<outputs.templates.ValueARequestValueItemProperties[] | outputs.templates.ValueARequestValueProperties | outputs.templates.ValueARequestValueItemProperties[] | outputs.templates.ValueARequestValueItemProperties[] | undefined>;
...
export interface AArgs {
     ...
     * The current mode for this record
     */
    mode?: pulumi.Input<enums.templates.APropertiesMode>;
    /**
     * The name for the record
     */
     ...
     * The type of record
     */
    type?: pulumi.Input<enums.templates.APropertiesType>;
    value?: pulumi.Input<pulumi.Input<inputs.templates.ValueARequestValueItemPropertiesArgs>[] | inputs.templates.ValueARequestValuePropertiesArgs | pulumi.Input<inputs.templates.ValueARequestValueItemPropertiesArgs>[] | pulumi.Input<inputs.templates.ValueARequestValueItemPropertiesArgs>[]>;
}
