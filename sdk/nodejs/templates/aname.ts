...
export class Aname extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): Aname {
        return new Aname(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'constellix:templates:Aname';

    /**
     * Returns true if the given object is an instance of Aname.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is Aname {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === Aname.__pulumiType;
    }
     ...
     */
    public readonly mode!: pulumi.Output<enums.templates.AnamePropertiesMode | undefined>;
    /**
     ...
     * The type of record
     */
    public readonly type!: pulumi.Output<enums.templates.AnamePropertiesType | undefined>;
    public readonly value!: pulumi.Output<outputs.templates.ValueAnameRequestValueItemProperties[] | outputs.templates.ValueAnameRequestValueProperties | outputs.templates.ValueAnameRequestValueItemProperties[] | undefined>;
     ...
     */
    constructor(name: string, args?: AnameArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        super(Aname.__pulumiType, name, resourceInputs, opts);
    }
}
...
export interface AnameArgs {
     ...
     * The current mode for this record
     */
    mode?: pulumi.Input<enums.templates.AnamePropertiesMode>;
    /**
     * The name for the record
     */
     ...
     * The type of record
     */
    type?: pulumi.Input<enums.templates.AnamePropertiesType>;
    value?: pulumi.Input<pulumi.Input<inputs.templates.ValueAnameRequestValueItemPropertiesArgs>[] | inputs.templates.ValueAnameRequestValuePropertiesArgs | pulumi.Input<inputs.templates.ValueAnameRequestValueItemPropertiesArgs>[]>;
}
