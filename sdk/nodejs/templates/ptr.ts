...
export class Ptr extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): Ptr {
        return new Ptr(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'constellix:templates:Ptr';

    /**
     * Returns true if the given object is an instance of Ptr.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is Ptr {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === Ptr.__pulumiType;
    }
     ...
     */
    public readonly mode!: pulumi.Output<enums.templates.PtrPropertiesMode | undefined>;
    /**
     ...
     * The type of record
     */
    public readonly type!: pulumi.Output<enums.templates.PtrPropertiesType | undefined>;
    /**
     * Standard record mode
     */
    public readonly value!: pulumi.Output<outputs.templates.ValuePtrValueItemProperties[] | undefined>;
     ...
     */
    constructor(name: string, args?: PtrArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        super(Ptr.__pulumiType, name, resourceInputs, opts);
    }
}
...
export interface PtrArgs {
     ...
     * The current mode for this record
     */
    mode?: pulumi.Input<enums.templates.PtrPropertiesMode>;
    /**
     * The name for the record
     */
     ...
     * The type of record
     */
    type?: pulumi.Input<enums.templates.PtrPropertiesType>;
    /**
     * Standard record mode
     */
    value?: pulumi.Input<pulumi.Input<inputs.templates.ValuePtrValueItemPropertiesArgs>[]>;
}
