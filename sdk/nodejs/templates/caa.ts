...
export class Caa extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'constellix:templates:Caa';
     ...
     */
    public readonly mode!: pulumi.Output<enums.templates.CaaPropertiesMode | undefined>;
    /**
     ...
     * The type of record
     */
    public readonly type!: pulumi.Output<enums.templates.CaaPropertiesType | undefined>;
    /**
     * Standard record mode
     */
    public readonly value!: pulumi.Output<outputs.templates.ValueCaaValueItemProperties[] | undefined>;
...
export interface CaaArgs {
     ...
     * The current mode for this record
     */
    mode?: pulumi.Input<enums.templates.CaaPropertiesMode>;
    /**
     * The name for the record
     */
     ...
     * The type of record
     */
    type?: pulumi.Input<enums.templates.CaaPropertiesType>;
    /**
     * Standard record mode
     */
    value?: pulumi.Input<pulumi.Input<inputs.templates.ValueCaaValueItemPropertiesArgs>[]>;
}
