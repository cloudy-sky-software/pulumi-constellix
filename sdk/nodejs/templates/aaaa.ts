...
export class Aaaa extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): Aaaa {
        return new Aaaa(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'constellix:templates:Aaaa';
     ...
     */
    public readonly mode!: pulumi.Output<enums.templates.AaaaPropertiesMode | undefined>;
    /**
     ...
     * The type of record
     */
    public readonly type!: pulumi.Output<enums.templates.AaaaPropertiesType | undefined>;
    public readonly value!: pulumi.Output<outputs.templates.ValueAaaaRequestValueItemProperties[] | outputs.templates.ValueAaaaRequestValueProperties | outputs.templates.ValueAaaaRequestValueItemProperties[] | outputs.templates.ValueAaaaRequestValueItemProperties[] | undefined>;
...
export interface AaaaArgs {
     ...
     * The current mode for this record
     */
    mode?: pulumi.Input<enums.templates.AaaaPropertiesMode>;
    /**
     * The name for the record
     */
     ...
     * The type of record
     */
    type?: pulumi.Input<enums.templates.AaaaPropertiesType>;
    value?: pulumi.Input<pulumi.Input<inputs.templates.ValueAaaaRequestValueItemPropertiesArgs>[] | inputs.templates.ValueAaaaRequestValuePropertiesArgs | pulumi.Input<inputs.templates.ValueAaaaRequestValueItemPropertiesArgs>[] | pulumi.Input<inputs.templates.ValueAaaaRequestValueItemPropertiesArgs>[]>;
}
