...
export class Srv extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): Srv {
        return new Srv(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'constellix:templates:Srv';

    /**
     * Returns true if the given object is an instance of Srv.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is Srv {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === Srv.__pulumiType;
    }
     ...
     */
    public readonly mode!: pulumi.Output<enums.templates.SrvPropertiesMode | undefined>;
    /**
     ...
     * The type of record
     */
    public readonly type!: pulumi.Output<enums.templates.SrvPropertiesType | undefined>;
    /**
     * Standard record mode
     */
    public readonly value!: pulumi.Output<outputs.templates.ValueSrvValueItemProperties[] | undefined>;
     ...
     */
    constructor(name: string, args?: SrvArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        super(Srv.__pulumiType, name, resourceInputs, opts);
    }
}
...
export interface SrvArgs {
     ...
     * The current mode for this record
     */
    mode?: pulumi.Input<enums.templates.SrvPropertiesMode>;
    /**
     * The name for the record
     */
     ...
     * The type of record
     */
    type?: pulumi.Input<enums.templates.SrvPropertiesType>;
    /**
     * Standard record mode
     */
    value?: pulumi.Input<pulumi.Input<inputs.templates.ValueSrvValueItemPropertiesArgs>[]>;
}
