...
export class Spf extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): Spf {
        return new Spf(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'constellix:templates:Spf';

    /**
     * Returns true if the given object is an instance of Spf.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is Spf {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === Spf.__pulumiType;
    }
     ...
     */
    public readonly mode!: pulumi.Output<enums.templates.SpfPropertiesMode | undefined>;
    /**
     ...
     * The type of record
     */
    public readonly type!: pulumi.Output<enums.templates.SpfPropertiesType | undefined>;
    /**
     * Standard record mode
     */
    public readonly value!: pulumi.Output<outputs.templates.ValueSpfValueItemProperties[] | undefined>;
     ...
     */
    constructor(name: string, args?: SpfArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        super(Spf.__pulumiType, name, resourceInputs, opts);
    }
}
...
export interface SpfArgs {
     ...
     * The current mode for this record
     */
    mode?: pulumi.Input<enums.templates.SpfPropertiesMode>;
    /**
     * The name for the record
     */
     ...
     * The type of record
     */
    type?: pulumi.Input<enums.templates.SpfPropertiesType>;
    /**
     * Standard record mode
     */
    value?: pulumi.Input<pulumi.Input<inputs.templates.ValueSpfValueItemPropertiesArgs>[]>;
}
