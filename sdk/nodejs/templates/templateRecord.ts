...
export class TemplateRecord extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): TemplateRecord {
        return new TemplateRecord(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'constellix:templates:TemplateRecord';

    /**
     * Returns true if the given object is an instance of TemplateRecord.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is TemplateRecord {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === TemplateRecord.__pulumiType;
    }
     ...
     */
    public readonly region!: pulumi.Output<enums.templates.TemplateRecordPropertiesRegion | undefined>;
    /**
     ...
     */
    constructor(name: string, args?: TemplateRecordArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        super(TemplateRecord.__pulumiType, name, resourceInputs, opts);
    }
}
...
export interface TemplateRecordArgs {
     ...
     * Optional region for this record. Will default to 'default'.
     */
    region?: pulumi.Input<enums.templates.TemplateRecordPropertiesRegion>;
    /**
     * Only used on POST or PATCH requests for ANAME records, used to specify whether the hostname should be looked up immediately. Will be null otherwise.
     */
