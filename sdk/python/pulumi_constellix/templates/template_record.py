...
__all__ = ['TemplateRecordArgs', 'TemplateRecord']

@pulumi.input_type
class TemplateRecordArgs:
    def __init__(__self__, *,
                 ...
                 region: Optional[pulumi.Input['TemplateRecordPropertiesRegion']] = None,
        ...
        :param pulumi.Input['TemplateRecordPropertiesRegion'] region: Optional region for this record. Will default to 'default'.
    ...
    @property
    @pulumi.getter
    def region(self) -> Optional[pulumi.Input['TemplateRecordPropertiesRegion']]:
        """
    ...
    @region.setter
    def region(self, value: Optional[pulumi.Input['TemplateRecordPropertiesRegion']]):
...
class TemplateRecord(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 ...
                 __props__=None):
        """
        Create a TemplateRecord resource with the given unique name, props, and options.
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: Optional[TemplateRecordArgs] = None,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        Create a TemplateRecord resource with the given unique name, props, and options.
        :param str resource_name: The name of the resource.
        :param TemplateRecordArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(TemplateRecordArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = TemplateRecordArgs.__new__(TemplateRecordArgs)
        ...
        super(TemplateRecord, __self__).__init__(
            'constellix:templates:TemplateRecord',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'TemplateRecord':
        """
        Get an existing TemplateRecord resource's state with the given name, id, and optional extra
        ...
        return TemplateRecord(resource_name, opts=opts, __props__=__props__)
    ...
    @property
    @pulumi.getter
    def region(self) -> pulumi.Output[Optional['TemplateRecordPropertiesRegion']]:
        """
        Optional region for this record. Will default to 'default'.
        """
        return pulumi.get(self, "region")
