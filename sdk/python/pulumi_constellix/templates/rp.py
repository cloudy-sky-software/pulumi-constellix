...
class RpArgs:
    def __init__(__self__, *,
                 ...
                 mode: Optional[pulumi.Input['RpPropertiesMode']] = None,
                 ...
                 type: Optional[pulumi.Input['RpPropertiesType']] = None,
                 value: Optional[pulumi.Input[Sequence[pulumi.Input['ValueRpValueItemPropertiesArgs']]]] = None):
        """
        ...
        :param pulumi.Input['RpPropertiesMode'] mode: The current mode for this record
        ...
        :param pulumi.Input['RpPropertiesType'] type: The type of record
        :param pulumi.Input[Sequence[pulumi.Input['ValueRpValueItemPropertiesArgs']]] value: Standard record mode
        """
    ...
    @property
    @pulumi.getter
    def mode(self) -> Optional[pulumi.Input['RpPropertiesMode']]:
        """
    ...
    @mode.setter
    def mode(self, value: Optional[pulumi.Input['RpPropertiesMode']]):
    ...
    @property
    @pulumi.getter
    def type(self) -> Optional[pulumi.Input['RpPropertiesType']]:
        """
        The type of record
        """
    ...
    @type.setter
    def type(self, value: Optional[pulumi.Input['RpPropertiesType']]):
        pulumi.set(self, "type", value)

    @property
    @pulumi.getter
    def value(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['ValueRpValueItemPropertiesArgs']]]]:
        """
    ...
    @value.setter
    def value(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['ValueRpValueItemPropertiesArgs']]]]):
        pulumi.set(self, "value", value)


class Rp(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 ...
                 ttl: Optional[pulumi.Input[int]] = None,
                 type: Optional[pulumi.Input['RpPropertiesType']] = None,
                 value: Optional[pulumi.Input[Sequence[pulumi.Input[Union['ValueRpValueItemPropertiesArgs', 'ValueRpValueItemPropertiesArgsDict']]]]] = None,
                 __props__=None):
        """
        Create a Rp resource with the given unique name, props, and options.
        ...
        :param pulumi.Input[int] ttl: How long DNS servers should cache the record for
        :param pulumi.Input['RpPropertiesType'] type: The type of record
        :param pulumi.Input[Sequence[pulumi.Input[Union['ValueRpValueItemPropertiesArgs', 'ValueRpValueItemPropertiesArgsDict']]]] value: Standard record mode
        """
        ...
    @overload
    def __init__(__self__,
                 resource_name: str,
                 args: Optional[RpArgs] = None,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        Create a Rp resource with the given unique name, props, and options.
        :param str resource_name: The name of the resource.
        :param RpArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(RpArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = RpArgs.__new__(RpArgs)
        ...
        super(Rp, __self__).__init__(
            'constellix:templates:Rp',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'Rp':
        """
        ...
        return Rp(resource_name, opts=opts, __props__=__props__)
    ...
    @property
    @pulumi.getter
    def mode(self) -> pulumi.Output[Optional['RpPropertiesMode']]:
        """
        The current mode for this record
        """
        return pulumi.get(self, "mode")
    ...
    @property
    @pulumi.getter
    def type(self) -> pulumi.Output[Optional['RpPropertiesType']]:
        """
        The type of record
        """
        return pulumi.get(self, "type")
    ...
    @property
    @pulumi.getter
    def value(self) -> pulumi.Output[Optional[Sequence['outputs.ValueRpValueItemProperties']]]:
        """
        Standard record mode
        """
        return pulumi.get(self, "value")
