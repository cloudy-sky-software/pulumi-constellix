...
def get_cname(id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('constellix:templates:getCNAME', __args__, opts=opts, typ=GetCNAME).value
...
def get_cname_output(id: Optional[pulumi.Input[str]] = None,
    ...
    __args__['templateId'] = template_id
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('constellix:templates:getCNAME', __args__, opts=opts, typ=GetCNAME)
