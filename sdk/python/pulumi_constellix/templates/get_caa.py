...
def get_caa(id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('constellix:templates:getCAA', __args__, opts=opts, typ=GetCAA).value
...
def get_caa_output(id: Optional[pulumi.Input[str]] = None,
    ...
    __args__['templateId'] = template_id
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('constellix:templates:getCAA', __args__, opts=opts, typ=GetCAA)
