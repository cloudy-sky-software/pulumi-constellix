...
def get_aname(id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('constellix:templates:getANAME', __args__, opts=opts, typ=GetANAME).value
...
def get_aname_output(id: Optional[pulumi.Input[str]] = None,
    ...
    __args__['templateId'] = template_id
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('constellix:templates:getANAME', __args__, opts=opts, typ=GetANAME)
