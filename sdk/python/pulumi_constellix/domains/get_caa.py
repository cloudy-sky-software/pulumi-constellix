...
@pulumi.output_type
class GetCAA:
    def __init__(__self__, contacts=None, domain=None, enabled=None, geo_failover=None, geoproximity=None, id=None, ipfilter=None, ipfilter_drop=None, last_values=None, links=None, mode=None, name=None, notes=None, region=None, skip_lookup=None, template=None, ttl=None, value=None):
    ...
    def last_values(self) -> Optional['outputs.GetCAAPropertiesLastValuesProperties']:
        """
    ...
    @property
    @pulumi.getter
    def mode(self) -> Optional['GetCAAPropertiesMode']:
        """
    ...
    @property
    @pulumi.getter
    def value(self) -> Optional[Sequence['outputs.ValueCaaValueItemProperties']]:
        """
...
def get_caa(domain_id: Optional[str] = None,
            id: Optional[str] = None,
            opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetCAA:
    """
    ...
    __ret__ = pulumi.runtime.invoke('constellix:domains:getCAA', __args__, opts=opts, typ=GetCAA).value

    return AwaitableGetCAA(
...
def get_caa_output(domain_id: Optional[pulumi.Input[str]] = None,
                   id: Optional[pulumi.Input[str]] = None,
                   opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetCAA]:
    """
    Use this data source to access information about an existing resource.
    ...
    __args__['id'] = id
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('constellix:domains:getCAA', __args__, opts=opts, typ=GetCAA)
    return __ret__.apply(lambda __response__: GetCAA(
