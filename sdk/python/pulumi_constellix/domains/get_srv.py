...
class GetSRV:
    ...
    def last_values(self) -> Optional['outputs.GetSRVPropertiesLastValuesProperties']:
        """
    ...
    @property
    @pulumi.getter
    def mode(self) -> Optional['GetSRVPropertiesMode']:
        """
    ...
    @property
    @pulumi.getter
    def type(self) -> Optional['GetSRVPropertiesType']:
        """
        The type of record
        """
    ...
    @property
    @pulumi.getter
    def value(self) -> Optional[Sequence['outputs.ValueSrvValueItemProperties']]:
        """
...
def get_srv(domain_id: Optional[str] = None,
            id: Optional[str] = None,
            opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetSRV:
    """
    ...
    __ret__ = pulumi.runtime.invoke('constellix:domains:getSRV', __args__, opts=opts, typ=GetSRV).value

    return AwaitableGetSRV(
...
def get_srv_output(domain_id: Optional[pulumi.Input[str]] = None,
                   id: Optional[pulumi.Input[str]] = None,
                   opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetSRV]:
    """
    Use this data source to access information about an existing resource.
    ...
    __args__['id'] = id
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('constellix:domains:getSRV', __args__, opts=opts, typ=GetSRV)
    return __ret__.apply(lambda __response__: GetSRV(
