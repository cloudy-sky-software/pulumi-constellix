...
class DomainRecordArgs:
    def __init__(__self__, *,
                 ...
                 region: Optional[pulumi.Input['DomainRecordPropertiesRegion']] = None,
        ...
        :param pulumi.Input['DomainRecordPropertiesRegion'] region: Optional region for this record. Will default to 'default'.
    ...
    @property
    @pulumi.getter
    def region(self) -> Optional[pulumi.Input['DomainRecordPropertiesRegion']]:
        """
    ...
    @region.setter
    def region(self, value: Optional[pulumi.Input['DomainRecordPropertiesRegion']]):
...
class DomainRecord(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: Optional[DomainRecordArgs] = None,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        Create a DomainRecord resource with the given unique name, props, and options.
        :param str resource_name: The name of the resource.
    ...
    def _internal_init(__self__,
        ...
        super(DomainRecord, __self__).__init__(
            'constellix:domains:DomainRecord',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'DomainRecord':
        """
    ...
    @property
    @pulumi.getter
    def region(self) -> pulumi.Output[Optional['DomainRecordPropertiesRegion']]:
        """
        Optional region for this record. Will default to 'default'.
        """
        return pulumi.get(self, "region")
