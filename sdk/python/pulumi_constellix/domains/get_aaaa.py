...
class GetAAAA:
    ...
    def last_values(self) -> Optional['outputs.GetAAAAPropertiesLastValuesProperties']:
        """
    ...
    @property
    @pulumi.getter
    def mode(self) -> Optional['GetAAAAPropertiesMode']:
        """
    ...
    @property
    @pulumi.getter
    def type(self) -> Optional['ValueAaaaType']:
        """
        The type of record
        """
    ...
    @property
    @pulumi.getter
    def value(self) -> Optional['outputs.ValueAaaaValue']:
        return pulumi.get(self, "value")


class AwaitableGetAAAA(GetAAAA):
...
def get_aaaa(domain_id: Optional[str] = None,
             id: Optional[str] = None,
             opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetAAAA:
    """
    ...
    __ret__ = pulumi.runtime.invoke('constellix:domains:getAAAA', __args__, opts=opts, typ=GetAAAA).value

    return AwaitableGetAAAA(
...
def get_aaaa_output(domain_id: Optional[pulumi.Input[str]] = None,
                    id: Optional[pulumi.Input[str]] = None,
                    opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetAAAA]:
    """
    Use this data source to access information about an existing resource.
    ...
    __args__['id'] = id
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('constellix:domains:getAAAA', __args__, opts=opts, typ=GetAAAA)
    return __ret__.apply(lambda __response__: GetAAAA(
