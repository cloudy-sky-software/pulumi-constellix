...
class GetNAPTR:
    ...
    def last_values(self) -> Optional['outputs.GetNAPTRPropertiesLastValuesProperties']:
        """
    ...
    @property
    @pulumi.getter
    def mode(self) -> Optional['GetNAPTRPropertiesMode']:
        """
    ...
    @property
    @pulumi.getter
    def type(self) -> Optional['GetNAPTRPropertiesType']:
        """
        The type of record
        """
    ...
    @property
    @pulumi.getter
    def value(self) -> Optional[Sequence['outputs.ValueNaptrValueItemProperties']]:
        """
...
class AwaitableGetNAPTR(GetNAPTR):
...
def get_naptr(domain_id: Optional[str] = None,
              id: Optional[str] = None,
              opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetNAPTR:
    """
    ...
    __ret__ = pulumi.runtime.invoke('constellix:domains:getNAPTR', __args__, opts=opts, typ=GetNAPTR).value

    return AwaitableGetNAPTR(
...
def get_naptr_output(domain_id: Optional[pulumi.Input[str]] = None,
                     id: Optional[pulumi.Input[str]] = None,
                     opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetNAPTR]:
    """
    Use this data source to access information about an existing resource.
    ...
    __args__['id'] = id
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('constellix:domains:getNAPTR', __args__, opts=opts, typ=GetNAPTR)
    return __ret__.apply(lambda __response__: GetNAPTR(
