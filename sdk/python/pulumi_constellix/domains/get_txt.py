...
class GetTXT:
    ...
    def last_values(self) -> Optional['outputs.GetTXTPropertiesLastValuesProperties']:
        """
    ...
    @property
    @pulumi.getter
    def mode(self) -> Optional['GetTXTPropertiesMode']:
        """
    ...
    @property
    @pulumi.getter
    def type(self) -> Optional['GetTXTPropertiesType']:
        """
        The type of record
        """
    ...
    @property
    @pulumi.getter
    def value(self) -> Optional[Sequence['outputs.ValueTxtValueItemProperties']]:
        """
...
def get_txt(domain_id: Optional[str] = None,
            id: Optional[str] = None,
            opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetTXT:
    """
    ...
    __ret__ = pulumi.runtime.invoke('constellix:domains:getTXT', __args__, opts=opts, typ=GetTXT).value

    return AwaitableGetTXT(
...
def get_txt_output(domain_id: Optional[pulumi.Input[str]] = None,
                   id: Optional[pulumi.Input[str]] = None,
                   opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetTXT]:
    """
    Use this data source to access information about an existing resource.
    ...
    __args__['id'] = id
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('constellix:domains:getTXT', __args__, opts=opts, typ=GetTXT)
    return __ret__.apply(lambda __response__: GetTXT(
