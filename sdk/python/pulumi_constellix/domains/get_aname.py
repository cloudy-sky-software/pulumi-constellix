...
class GetANAME:
    ...
    def last_values(self) -> Optional['outputs.GetANAMEPropertiesLastValuesProperties']:
        """
    ...
    @property
    @pulumi.getter
    def mode(self) -> Optional['GetANAMEPropertiesMode']:
        """
    ...
    @property
    @pulumi.getter
    def type(self) -> Optional['ValueAnameType']:
        """
        The type of record
        """
...
class AwaitableGetANAME(GetANAME):
...
def get_aname(domain_id: Optional[str] = None,
              id: Optional[str] = None,
              opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetANAME:
    """
    ...
    __ret__ = pulumi.runtime.invoke('constellix:domains:getANAME', __args__, opts=opts, typ=GetANAME).value

    return AwaitableGetANAME(
...
def get_aname_output(domain_id: Optional[pulumi.Input[str]] = None,
                     id: Optional[pulumi.Input[str]] = None,
                     opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetANAME]:
    """
    Use this data source to access information about an existing resource.
    ...
    __args__['id'] = id
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('constellix:domains:getANAME', __args__, opts=opts, typ=GetANAME)
    return __ret__.apply(lambda __response__: GetANAME(
