...
class GetSPF:
    ...
    def last_values(self) -> Optional['outputs.GetSPFPropertiesLastValuesProperties']:
        """
    ...
    @property
    @pulumi.getter
    def mode(self) -> Optional['GetSPFPropertiesMode']:
        """
    ...
    @property
    @pulumi.getter
    def type(self) -> Optional['GetSPFPropertiesType']:
        """
        The type of record
        """
    ...
    @property
    @pulumi.getter
    def value(self) -> Optional[Sequence['outputs.ValueSpfValueItemProperties']]:
        """
...
def get_spf(domain_id: Optional[str] = None,
            id: Optional[str] = None,
            opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetSPF:
    """
    ...
    __ret__ = pulumi.runtime.invoke('constellix:domains:getSPF', __args__, opts=opts, typ=GetSPF).value

    return AwaitableGetSPF(
...
def get_spf_output(domain_id: Optional[pulumi.Input[str]] = None,
                   id: Optional[pulumi.Input[str]] = None,
                   opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetSPF]:
    """
    Use this data source to access information about an existing resource.
    ...
    __args__['id'] = id
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('constellix:domains:getSPF', __args__, opts=opts, typ=GetSPF)
    return __ret__.apply(lambda __response__: GetSPF(
