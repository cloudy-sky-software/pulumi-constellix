...
def get_a(domain_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('constellix:domains:getA', __args__, opts=opts, typ=GetA).value
...
def get_a_output(domain_id: Optional[pulumi.Input[str]] = None,
    ...
    __args__['id'] = id
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('constellix:domains:getA', __args__, opts=opts, typ=GetA)
