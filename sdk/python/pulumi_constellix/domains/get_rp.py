...
class GetRP:
    ...
    def last_values(self) -> Optional['outputs.GetRPPropertiesLastValuesProperties']:
        """
    ...
    @property
    @pulumi.getter
    def mode(self) -> Optional['GetRPPropertiesMode']:
        """
    ...
    @property
    @pulumi.getter
    def type(self) -> Optional['GetRPPropertiesType']:
        """
        The type of record
        """
    ...
    @property
    @pulumi.getter
    def value(self) -> Optional[Sequence['outputs.ValueRpValueItemProperties']]:
        """
...
def get_rp(domain_id: Optional[str] = None,
           id: Optional[str] = None,
           opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetRP:
    """
    ...
    __ret__ = pulumi.runtime.invoke('constellix:domains:getRP', __args__, opts=opts, typ=GetRP).value

    return AwaitableGetRP(
...
def get_rp_output(domain_id: Optional[pulumi.Input[str]] = None,
                  id: Optional[pulumi.Input[str]] = None,
                  opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetRP]:
    """
    Use this data source to access information about an existing resource.
    ...
    __args__['id'] = id
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('constellix:domains:getRP', __args__, opts=opts, typ=GetRP)
    return __ret__.apply(lambda __response__: GetRP(
