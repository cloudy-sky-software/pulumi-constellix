...
class GetHttp:
    ...
    def last_values(self) -> Optional['outputs.GetHttpPropertiesLastValuesProperties']:
        """
    ...
    @property
    @pulumi.getter
    def mode(self) -> Optional['GetHttpPropertiesMode']:
        """
    ...
    @property
    @pulumi.getter
    def type(self) -> Optional['GetHttpPropertiesType']:
        """
        The type of record
        """
    ...
    @property
    @pulumi.getter
    def value(self) -> Optional['outputs.ValueHttpValueProperties']:
        return pulumi.get(self, "value")


class AwaitableGetHttp(GetHttp):
...
def get_http(domain_id: Optional[str] = None,
             id: Optional[str] = None,
             opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetHttp:
    """
    ...
    __ret__ = pulumi.runtime.invoke('constellix:domains:getHttp', __args__, opts=opts, typ=GetHttp).value

    return AwaitableGetHttp(
...
def get_http_output(domain_id: Optional[pulumi.Input[str]] = None,
                    id: Optional[pulumi.Input[str]] = None,
                    opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetHttp]:
    """
    Use this data source to access information about an existing resource.
    ...
    __args__['id'] = id
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('constellix:domains:getHttp', __args__, opts=opts, typ=GetHttp)
    return __ret__.apply(lambda __response__: GetHttp(
