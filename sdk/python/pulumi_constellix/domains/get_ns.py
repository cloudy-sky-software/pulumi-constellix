...
class GetNS:
    ...
    def last_values(self) -> Optional['outputs.GetNSPropertiesLastValuesProperties']:
        """
    ...
    @property
    @pulumi.getter
    def mode(self) -> Optional['GetNSPropertiesMode']:
        """
    ...
    @property
    @pulumi.getter
    def type(self) -> Optional['GetNSPropertiesType']:
        """
        The type of record
        """
    ...
    @property
    @pulumi.getter
    def value(self) -> Optional[Sequence['outputs.ValueNsValueItemProperties']]:
        """
...
def get_ns(domain_id: Optional[str] = None,
           id: Optional[str] = None,
           opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetNS:
    """
    ...
    __ret__ = pulumi.runtime.invoke('constellix:domains:getNS', __args__, opts=opts, typ=GetNS).value

    return AwaitableGetNS(
...
def get_ns_output(domain_id: Optional[pulumi.Input[str]] = None,
                  id: Optional[pulumi.Input[str]] = None,
                  opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetNS]:
    """
    Use this data source to access information about an existing resource.
    ...
    __args__['id'] = id
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('constellix:domains:getNS', __args__, opts=opts, typ=GetNS)
    return __ret__.apply(lambda __response__: GetNS(
