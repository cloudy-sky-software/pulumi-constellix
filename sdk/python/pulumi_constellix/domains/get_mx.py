...
class GetMX:
    ...
    def last_values(self) -> Optional['outputs.GetMXPropertiesLastValuesProperties']:
        """
    ...
    @property
    @pulumi.getter
    def mode(self) -> Optional['GetMXPropertiesMode']:
        """
    ...
    @property
    @pulumi.getter
    def type(self) -> Optional['GetMXPropertiesType']:
        """
        The type of record
        """
    ...
    @property
    @pulumi.getter
    def value(self) -> Optional[Sequence['outputs.ValueMxValueItemProperties']]:
        """
...
def get_mx(domain_id: Optional[str] = None,
           id: Optional[str] = None,
           opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetMX:
    """
    ...
    __ret__ = pulumi.runtime.invoke('constellix:domains:getMX', __args__, opts=opts, typ=GetMX).value

    return AwaitableGetMX(
...
def get_mx_output(domain_id: Optional[pulumi.Input[str]] = None,
                  id: Optional[pulumi.Input[str]] = None,
                  opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetMX]:
    """
    Use this data source to access information about an existing resource.
    ...
    __args__['id'] = id
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('constellix:domains:getMX', __args__, opts=opts, typ=GetMX)
    return __ret__.apply(lambda __response__: GetMX(
