...
class GetCERT:
    ...
    def last_values(self) -> Optional['outputs.GetCERTPropertiesLastValuesProperties']:
        """
    ...
    @property
    @pulumi.getter
    def mode(self) -> Optional['GetCERTPropertiesMode']:
        """
    ...
    @property
    @pulumi.getter
    def type(self) -> Optional['GetCERTPropertiesType']:
        """
        The type of record
        """
    ...
    @property
    @pulumi.getter
    def value(self) -> Optional[Sequence['outputs.ValueCertValueItemProperties']]:
        """
...
class AwaitableGetCERT(GetCERT):
...
def get_cert(domain_id: Optional[str] = None,
             id: Optional[str] = None,
             opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetCERT:
    """
    ...
    __ret__ = pulumi.runtime.invoke('constellix:domains:getCERT', __args__, opts=opts, typ=GetCERT).value

    return AwaitableGetCERT(
...
def get_cert_output(domain_id: Optional[pulumi.Input[str]] = None,
                    id: Optional[pulumi.Input[str]] = None,
                    opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetCERT]:
    """
    Use this data source to access information about an existing resource.
    ...
    __args__['id'] = id
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('constellix:domains:getCERT', __args__, opts=opts, typ=GetCERT)
    return __ret__.apply(lambda __response__: GetCERT(
