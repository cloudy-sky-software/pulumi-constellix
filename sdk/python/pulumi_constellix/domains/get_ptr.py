...
class GetPTR:
    ...
    def last_values(self) -> Optional['outputs.GetPTRPropertiesLastValuesProperties']:
        """
    ...
    @property
    @pulumi.getter
    def mode(self) -> Optional['GetPTRPropertiesMode']:
        """
    ...
    @property
    @pulumi.getter
    def type(self) -> Optional['GetPTRPropertiesType']:
        """
        The type of record
        """
    ...
    @property
    @pulumi.getter
    def value(self) -> Optional[Sequence['outputs.ValuePtrValueItemProperties']]:
        """
...
def get_ptr(domain_id: Optional[str] = None,
            id: Optional[str] = None,
            opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetPTR:
    """
    ...
    __ret__ = pulumi.runtime.invoke('constellix:domains:getPTR', __args__, opts=opts, typ=GetPTR).value

    return AwaitableGetPTR(
...
def get_ptr_output(domain_id: Optional[pulumi.Input[str]] = None,
                   id: Optional[pulumi.Input[str]] = None,
                   opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetPTR]:
    """
    Use this data source to access information about an existing resource.
    ...
    __args__['id'] = id
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('constellix:domains:getPTR', __args__, opts=opts, typ=GetPTR)
    return __ret__.apply(lambda __response__: GetPTR(
