...
class GetCNAME:
    ...
    def last_values(self) -> Optional['outputs.GetCNAMEPropertiesLastValuesProperties']:
        """
    ...
    @property
    @pulumi.getter
    def mode(self) -> Optional['GetCNAMEPropertiesMode']:
        """
    ...
    @property
    @pulumi.getter
    def type(self) -> Optional['ValueCnameType']:
        """
        The type of record
        """
    ...
    @property
    @pulumi.getter
    def value(self) -> Optional['outputs.ValueCnameValue']:
        return pulumi.get(self, "value")


class AwaitableGetCNAME(GetCNAME):
...
def get_cname(domain_id: Optional[str] = None,
              id: Optional[str] = None,
              opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetCNAME:
    """
    ...
    __ret__ = pulumi.runtime.invoke('constellix:domains:getCNAME', __args__, opts=opts, typ=GetCNAME).value

    return AwaitableGetCNAME(
...
def get_cname_output(domain_id: Optional[pulumi.Input[str]] = None,
                     id: Optional[pulumi.Input[str]] = None,
                     opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetCNAME]:
    """
    Use this data source to access information about an existing resource.
    ...
    __args__['id'] = id
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('constellix:domains:getCNAME', __args__, opts=opts, typ=GetCNAME)
    return __ret__.apply(lambda __response__: GetCNAME(
