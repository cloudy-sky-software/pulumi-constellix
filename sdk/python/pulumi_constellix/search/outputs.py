...
__all__ = [
    'Domainsearchresult',
    'DomainsearchresultLinksProperties',
    'ListMetadata',
...
@pulumi.output_type
class Domainsearchresult(dict):
    """
    Represents a search result when searching for domains
    """
    def __init__(__self__, *,
                 id: Optional[int] = None,
                 links: Optional['outputs.DomainsearchresultLinksProperties'] = None,
                 name: Optional[str] = None):
        """
        Represents a search result when searching for domains
        :param int id: The ID for the domain name
        :param 'DomainsearchresultLinksProperties' links: Links for domain search results
    ...
    @property
    @pulumi.getter
    def links(self) -> Optional['outputs.DomainsearchresultLinksProperties']:
        """
...
@pulumi.output_type
class DomainsearchresultLinksProperties(dict):
    """
    Links for domain search results
    """
    def __init__(__self__, *,
