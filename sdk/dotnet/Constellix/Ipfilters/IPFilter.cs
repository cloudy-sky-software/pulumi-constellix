...
namespace CloudySkySoftware.Pulumi.Constellix.Ipfilters
{
    ...
    public partial class IPFilter : global::Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("continents")]
        public Output<ImmutableArray<CloudySkySoftware.Pulumi.Constellix.Ipfilters.ContinentsItem>> Continents { get; private set; } = null!;
    ...
    public sealed class IPFilterArgs : global::Pulumi.ResourceArgs
    {
        ...
        [Input("continents")]
        private InputList<CloudySkySoftware.Pulumi.Constellix.Ipfilters.ContinentsItem>? _continents;

        /// <summary>
        /// A list of continents in this filter
        /// </summary>
        public InputList<CloudySkySoftware.Pulumi.Constellix.Ipfilters.ContinentsItem> Continents
        {
            get => _continents ?? (_continents = new InputList<CloudySkySoftware.Pulumi.Constellix.Ipfilters.ContinentsItem>());
