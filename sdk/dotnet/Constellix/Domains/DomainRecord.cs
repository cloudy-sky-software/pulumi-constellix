...
{
    [ConstellixResourceType("constellix:domains:DomainRecord")]
    public partial class DomainRecord : global::Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("region")]
        public Output<CloudySkySoftware.Pulumi.Constellix.Domains.DomainRecordPropertiesRegion?> Region { get; private set; } = null!;
        ...
        public DomainRecord(string name, DomainRecordArgs? args = null, CustomResourceOptions? options = null)
            : base("constellix:domains:DomainRecord", name, args ?? new DomainRecordArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DomainRecord(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("constellix:domains:DomainRecord", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static DomainRecord Get(string name, Input<string> id, CustomResourceOptions? options = null)
        {
            return new DomainRecord(name, id, options);
        }
    }
    ...
    public sealed class DomainRecordArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("region")]
        public Input<CloudySkySoftware.Pulumi.Constellix.Domains.DomainRecordPropertiesRegion>? Region { get; set; }
