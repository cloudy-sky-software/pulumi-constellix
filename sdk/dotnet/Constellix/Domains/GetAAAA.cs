...
namespace CloudySkySoftware.Pulumi.Constellix.Domains
{
    public static class GetAAAA
    {
        public static Task<Outputs.GetAAAA> InvokeAsync(GetAAAAArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<Outputs.GetAAAA>("constellix:domains:getAAAA", args ?? new GetAAAAArgs(), options.WithDefaults());

        public static Output<Outputs.GetAAAA> Invoke(GetAAAAInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<Outputs.GetAAAA>("constellix:domains:getAAAA", args ?? new GetAAAAInvokeArgs(), options.WithDefaults());
    }
