...
{
    [ConstellixResourceType("constellix:templates:Cert")]
    public partial class Cert : global::Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("mode")]
        public Output<CloudySkySoftware.Pulumi.Constellix.Templates.CertPropertiesMode?> Mode { get; private set; } = null!;
        ...
        /// </summary>
        [Output("type")]
        public Output<CloudySkySoftware.Pulumi.Constellix.Templates.CertPropertiesType?> Type { get; private set; } = null!;
        ...
        public Cert(string name, CertArgs? args = null, CustomResourceOptions? options = null)
            : base("constellix:templates:Cert", name, args ?? new CertArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Cert(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("constellix:templates:Cert", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class CertArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("mode")]
        public Input<CloudySkySoftware.Pulumi.Constellix.Templates.CertPropertiesMode>? Mode { get; set; }
        ...
        /// </summary>
        [Input("type")]
        public Input<CloudySkySoftware.Pulumi.Constellix.Templates.CertPropertiesType>? Type { get; set; }
