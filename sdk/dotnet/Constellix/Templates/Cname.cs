...
{
    [ConstellixResourceType("constellix:templates:Cname")]
    public partial class Cname : global::Pulumi.CustomResource
    {
        /// <summary>
        ...
        /// </summary>
        [Output("mode")]
        public Output<CloudySkySoftware.Pulumi.Constellix.Templates.CnamePropertiesMode?> Mode { get; private set; } = null!;
        ...
        /// </summary>
        [Output("type")]
        public Output<CloudySkySoftware.Pulumi.Constellix.Templates.CnamePropertiesType?> Type { get; private set; } = null!;

        [Output("value")]
        public Output<Union<ImmutableArray<Outputs.ValueCnameRequestValueItemProperties>, Outputs.ValueCnameRequestValueProperties>?> Value { get; private set; } = null!;
        ...
        public Cname(string name, CnameArgs? args = null, CustomResourceOptions? options = null)
            : base("constellix:templates:Cname", name, args ?? new CnameArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Cname(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("constellix:templates:Cname", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static Cname Get(string name, Input<string> id, CustomResourceOptions? options = null)
        {
            return new Cname(name, id, options);
        }
    }

    public sealed class CnameArgs : global::Pulumi.ResourceArgs
    {
        [Input("contacts")]
        ...
        /// </summary>
        [Input("mode")]
        public Input<CloudySkySoftware.Pulumi.Constellix.Templates.CnamePropertiesMode>? Mode { get; set; }
        ...
        /// </summary>
        [Input("type")]
        public Input<CloudySkySoftware.Pulumi.Constellix.Templates.CnamePropertiesType>? Type { get; set; }

        [Input("value")]
        public InputUnion<ImmutableArray<Inputs.ValueCnameRequestValueItemPropertiesArgs>, Inputs.ValueCnameRequestValuePropertiesArgs>? Value { get; set; }

        public CnameArgs()
        {
        }
        public static new CnameArgs Empty => new CnameArgs();
    }
}
