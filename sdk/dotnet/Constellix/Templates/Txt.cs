...
{
    [ConstellixResourceType("constellix:templates:Txt")]
    public partial class Txt : global::Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("mode")]
        public Output<CloudySkySoftware.Pulumi.Constellix.Templates.TxtPropertiesMode?> Mode { get; private set; } = null!;
        ...
        /// </summary>
        [Output("type")]
        public Output<CloudySkySoftware.Pulumi.Constellix.Templates.TxtPropertiesType?> Type { get; private set; } = null!;

        /// <summary>
        /// Standard record mode
        /// </summary>
        [Output("value")]
        public Output<ImmutableArray<Outputs.ValueTxtValueItemProperties>> Value { get; private set; } = null!;
        ...
        public Txt(string name, TxtArgs? args = null, CustomResourceOptions? options = null)
            : base("constellix:templates:Txt", name, args ?? new TxtArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Txt(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("constellix:templates:Txt", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class TxtArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("mode")]
        public Input<CloudySkySoftware.Pulumi.Constellix.Templates.TxtPropertiesMode>? Mode { get; set; }
        ...
        /// </summary>
        [Input("type")]
        public Input<CloudySkySoftware.Pulumi.Constellix.Templates.TxtPropertiesType>? Type { get; set; }

        [Input("value")]
        private InputList<Inputs.ValueTxtValueItemPropertiesArgs>? _value;

        /// <summary>
        /// Standard record mode
        /// </summary>
        public InputList<Inputs.ValueTxtValueItemPropertiesArgs> Value
        {
            get => _value ?? (_value = new InputList<Inputs.ValueTxtValueItemPropertiesArgs>());
            set => _value = value;
        }
