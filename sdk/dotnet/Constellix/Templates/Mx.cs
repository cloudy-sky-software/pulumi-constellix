...
{
    [ConstellixResourceType("constellix:templates:Mx")]
    public partial class Mx : global::Pulumi.CustomResource
    {
        /// <summary>
        ...
        /// </summary>
        [Output("mode")]
        public Output<CloudySkySoftware.Pulumi.Constellix.Templates.MxPropertiesMode?> Mode { get; private set; } = null!;
        ...
        /// </summary>
        [Output("type")]
        public Output<CloudySkySoftware.Pulumi.Constellix.Templates.MxPropertiesType?> Type { get; private set; } = null!;

        /// <summary>
        /// Standard record mode
        /// </summary>
        [Output("value")]
        public Output<ImmutableArray<Outputs.ValueMxValueItemProperties>> Value { get; private set; } = null!;


        /// <summary>
        /// Create a Mx resource with the given unique name, arguments, and options.
        /// </summary>
        ///
        /// <param name="name">The unique name of the resource</param>
        /// <param name="args">The arguments used to populate this resource's properties</param>
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public Mx(string name, MxArgs? args = null, CustomResourceOptions? options = null)
            : base("constellix:templates:Mx", name, args ?? new MxArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Mx(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("constellix:templates:Mx", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static Mx Get(string name, Input<string> id, CustomResourceOptions? options = null)
        {
            return new Mx(name, id, options);
        }
    }

    public sealed class MxArgs : global::Pulumi.ResourceArgs
    {
        [Input("contacts")]
        ...
        /// </summary>
        [Input("mode")]
        public Input<CloudySkySoftware.Pulumi.Constellix.Templates.MxPropertiesMode>? Mode { get; set; }
        ...
        /// </summary>
        [Input("type")]
        public Input<CloudySkySoftware.Pulumi.Constellix.Templates.MxPropertiesType>? Type { get; set; }

        [Input("value")]
        private InputList<Inputs.ValueMxValueItemPropertiesArgs>? _value;

        /// <summary>
        /// Standard record mode
        /// </summary>
        public InputList<Inputs.ValueMxValueItemPropertiesArgs> Value
        {
            get => _value ?? (_value = new InputList<Inputs.ValueMxValueItemPropertiesArgs>());
            set => _value = value;
        }
        ...
        public static new MxArgs Empty => new MxArgs();
    }
}
