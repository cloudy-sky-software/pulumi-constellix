...
{
    [ConstellixResourceType("constellix:templates:Rp")]
    public partial class Rp : global::Pulumi.CustomResource
    {
        /// <summary>
        ...
        /// </summary>
        [Output("mode")]
        public Output<CloudySkySoftware.Pulumi.Constellix.Templates.RpPropertiesMode?> Mode { get; private set; } = null!;
        ...
        /// </summary>
        [Output("type")]
        public Output<CloudySkySoftware.Pulumi.Constellix.Templates.RpPropertiesType?> Type { get; private set; } = null!;

        /// <summary>
        /// Standard record mode
        /// </summary>
        [Output("value")]
        public Output<ImmutableArray<Outputs.ValueRpValueItemProperties>> Value { get; private set; } = null!;
        ...
        public Rp(string name, RpArgs? args = null, CustomResourceOptions? options = null)
            : base("constellix:templates:Rp", name, args ?? new RpArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Rp(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("constellix:templates:Rp", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static Rp Get(string name, Input<string> id, CustomResourceOptions? options = null)
        {
            return new Rp(name, id, options);
        }
    }

    public sealed class RpArgs : global::Pulumi.ResourceArgs
    {
        [Input("contacts")]
        ...
        /// </summary>
        [Input("mode")]
        public Input<CloudySkySoftware.Pulumi.Constellix.Templates.RpPropertiesMode>? Mode { get; set; }
        ...
        /// </summary>
        [Input("type")]
        public Input<CloudySkySoftware.Pulumi.Constellix.Templates.RpPropertiesType>? Type { get; set; }

        [Input("value")]
        private InputList<Inputs.ValueRpValueItemPropertiesArgs>? _value;

        /// <summary>
        /// Standard record mode
        /// </summary>
        public InputList<Inputs.ValueRpValueItemPropertiesArgs> Value
        {
            get => _value ?? (_value = new InputList<Inputs.ValueRpValueItemPropertiesArgs>());
            set => _value = value;
        }
        ...
        public static new RpArgs Empty => new RpArgs();
    }
}
