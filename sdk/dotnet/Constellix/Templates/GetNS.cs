...
namespace CloudySkySoftware.Pulumi.Constellix.Templates
{
    public static class GetNS
    {
        public static Task<Outputs.GetNS> InvokeAsync(GetNSArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<Outputs.GetNS>("constellix:templates:getNS", args ?? new GetNSArgs(), options.WithDefaults());

        public static Output<Outputs.GetNS> Invoke(GetNSInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<Outputs.GetNS>("constellix:templates:getNS", args ?? new GetNSInvokeArgs(), options.WithDefaults());
    }
