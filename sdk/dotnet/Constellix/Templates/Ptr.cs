...
{
    [ConstellixResourceType("constellix:templates:Ptr")]
    public partial class Ptr : global::Pulumi.CustomResource
    {
        /// <summary>
        ...
        /// </summary>
        [Output("mode")]
        public Output<CloudySkySoftware.Pulumi.Constellix.Templates.PtrPropertiesMode?> Mode { get; private set; } = null!;
        ...
        /// </summary>
        [Output("type")]
        public Output<CloudySkySoftware.Pulumi.Constellix.Templates.PtrPropertiesType?> Type { get; private set; } = null!;

        /// <summary>
        /// Standard record mode
        /// </summary>
        [Output("value")]
        public Output<ImmutableArray<Outputs.ValuePtrValueItemProperties>> Value { get; private set; } = null!;


        /// <summary>
        /// Create a Ptr resource with the given unique name, arguments, and options.
        /// </summary>
        ///
        /// <param name="name">The unique name of the resource</param>
        /// <param name="args">The arguments used to populate this resource's properties</param>
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public Ptr(string name, PtrArgs? args = null, CustomResourceOptions? options = null)
            : base("constellix:templates:Ptr", name, args ?? new PtrArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Ptr(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("constellix:templates:Ptr", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static Ptr Get(string name, Input<string> id, CustomResourceOptions? options = null)
        {
            return new Ptr(name, id, options);
        }
    }

    public sealed class PtrArgs : global::Pulumi.ResourceArgs
    {
        [Input("contacts")]
        ...
        /// </summary>
        [Input("mode")]
        public Input<CloudySkySoftware.Pulumi.Constellix.Templates.PtrPropertiesMode>? Mode { get; set; }
        ...
        /// </summary>
        [Input("type")]
        public Input<CloudySkySoftware.Pulumi.Constellix.Templates.PtrPropertiesType>? Type { get; set; }

        [Input("value")]
        private InputList<Inputs.ValuePtrValueItemPropertiesArgs>? _value;

        /// <summary>
        /// Standard record mode
        /// </summary>
        public InputList<Inputs.ValuePtrValueItemPropertiesArgs> Value
        {
            get => _value ?? (_value = new InputList<Inputs.ValuePtrValueItemPropertiesArgs>());
            set => _value = value;
        }
        ...
        public static new PtrArgs Empty => new PtrArgs();
    }
}
