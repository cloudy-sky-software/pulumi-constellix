...
{
    [ConstellixResourceType("constellix:templates:Aaaa")]
    public partial class Aaaa : global::Pulumi.CustomResource
    {
        /// <summary>
        ...
        /// </summary>
        [Output("mode")]
        public Output<CloudySkySoftware.Pulumi.Constellix.Templates.AaaaPropertiesMode?> Mode { get; private set; } = null!;
        ...
        /// </summary>
        [Output("type")]
        public Output<CloudySkySoftware.Pulumi.Constellix.Templates.AaaaPropertiesType?> Type { get; private set; } = null!;

        [Output("value")]
        public Output<Union<ImmutableArray<Outputs.ValueAaaaRequestValueItemProperties>, Outputs.ValueAaaaRequestValueProperties>?> Value { get; private set; } = null!;
        ...
        public Aaaa(string name, AaaaArgs? args = null, CustomResourceOptions? options = null)
            : base("constellix:templates:Aaaa", name, args ?? new AaaaArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Aaaa(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("constellix:templates:Aaaa", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static Aaaa Get(string name, Input<string> id, CustomResourceOptions? options = null)
        {
            return new Aaaa(name, id, options);
        }
    }

    public sealed class AaaaArgs : global::Pulumi.ResourceArgs
    {
        [Input("contacts")]
        ...
        /// </summary>
        [Input("mode")]
        public Input<CloudySkySoftware.Pulumi.Constellix.Templates.AaaaPropertiesMode>? Mode { get; set; }
        ...
        /// </summary>
        [Input("type")]
        public Input<CloudySkySoftware.Pulumi.Constellix.Templates.AaaaPropertiesType>? Type { get; set; }

        [Input("value")]
        public InputUnion<ImmutableArray<Inputs.ValueAaaaRequestValueItemPropertiesArgs>, Inputs.ValueAaaaRequestValuePropertiesArgs>? Value { get; set; }

        public AaaaArgs()
        {
        }
        public static new AaaaArgs Empty => new AaaaArgs();
    }
}
