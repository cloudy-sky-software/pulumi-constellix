...
{
    [ConstellixResourceType("constellix:templates:A")]
    public partial class A : global::Pulumi.CustomResource
    {
        /// <summary>
        ...
        /// </summary>
        [Output("mode")]
        public Output<CloudySkySoftware.Pulumi.Constellix.Templates.APropertiesMode?> Mode { get; private set; } = null!;
        ...
        /// </summary>
        [Output("type")]
        public Output<CloudySkySoftware.Pulumi.Constellix.Templates.APropertiesType?> Type { get; private set; } = null!;

        [Output("value")]
        public Output<Union<ImmutableArray<Outputs.ValueARequestValueItemProperties>, Outputs.ValueARequestValueProperties>?> Value { get; private set; } = null!;
        ...
        public A(string name, AArgs? args = null, CustomResourceOptions? options = null)
            : base("constellix:templates:A", name, args ?? new AArgs(), MakeResourceOptions(options, ""))
        {
        }

        private A(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("constellix:templates:A", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class AArgs : global::Pulumi.ResourceArgs
    {
        [Input("contacts")]
        ...
        /// </summary>
        [Input("mode")]
        public Input<CloudySkySoftware.Pulumi.Constellix.Templates.APropertiesMode>? Mode { get; set; }
        ...
        /// </summary>
        [Input("type")]
        public Input<CloudySkySoftware.Pulumi.Constellix.Templates.APropertiesType>? Type { get; set; }

        [Input("value")]
        public InputUnion<ImmutableArray<Inputs.ValueARequestValueItemPropertiesArgs>, Inputs.ValueARequestValuePropertiesArgs>? Value { get; set; }

        public AArgs()
        {
        }
        public static new AArgs Empty => new AArgs();
    }
}
