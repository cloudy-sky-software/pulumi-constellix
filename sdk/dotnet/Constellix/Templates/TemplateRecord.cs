...
{
    [ConstellixResourceType("constellix:templates:TemplateRecord")]
    public partial class TemplateRecord : global::Pulumi.CustomResource
    {
        /// <summary>
        ...
        /// </summary>
        [Output("region")]
        public Output<CloudySkySoftware.Pulumi.Constellix.Templates.TemplateRecordPropertiesRegion?> Region { get; private set; } = null!;
        ...
        /// <summary>
        /// Create a TemplateRecord resource with the given unique name, arguments, and options.
        /// </summary>
        ///
        /// <param name="name">The unique name of the resource</param>
        /// <param name="args">The arguments used to populate this resource's properties</param>
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public TemplateRecord(string name, TemplateRecordArgs? args = null, CustomResourceOptions? options = null)
            : base("constellix:templates:TemplateRecord", name, args ?? new TemplateRecordArgs(), MakeResourceOptions(options, ""))
        {
        }

        private TemplateRecord(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("constellix:templates:TemplateRecord", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static TemplateRecord Get(string name, Input<string> id, CustomResourceOptions? options = null)
        {
            return new TemplateRecord(name, id, options);
        }
    }

    public sealed class TemplateRecordArgs : global::Pulumi.ResourceArgs
    {
        [Input("contacts")]
        ...
        /// </summary>
        [Input("region")]
        public Input<CloudySkySoftware.Pulumi.Constellix.Templates.TemplateRecordPropertiesRegion>? Region { get; set; }
        ...
        public TemplateRecordArgs()
        {
        }
        public static new TemplateRecordArgs Empty => new TemplateRecordArgs();
    }
}
