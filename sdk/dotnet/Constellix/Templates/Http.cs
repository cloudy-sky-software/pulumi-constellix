...
{
    [ConstellixResourceType("constellix:templates:Http")]
    public partial class Http : global::Pulumi.CustomResource
    {
        /// <summary>
        ...
        /// </summary>
        [Output("mode")]
        public Output<CloudySkySoftware.Pulumi.Constellix.Templates.HttpPropertiesMode?> Mode { get; private set; } = null!;
        ...
        /// </summary>
        [Output("type")]
        public Output<CloudySkySoftware.Pulumi.Constellix.Templates.HttpPropertiesType?> Type { get; private set; } = null!;

        [Output("value")]
        public Output<Outputs.ValueHttpValueProperties?> Value { get; private set; } = null!;
        ...
        public Http(string name, HttpArgs? args = null, CustomResourceOptions? options = null)
            : base("constellix:templates:Http", name, args ?? new HttpArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Http(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("constellix:templates:Http", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static Http Get(string name, Input<string> id, CustomResourceOptions? options = null)
        {
            return new Http(name, id, options);
        }
    }
    ...
    public sealed class HttpArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("mode")]
        public Input<CloudySkySoftware.Pulumi.Constellix.Templates.HttpPropertiesMode>? Mode { get; set; }
        ...
        /// </summary>
        [Input("type")]
        public Input<CloudySkySoftware.Pulumi.Constellix.Templates.HttpPropertiesType>? Type { get; set; }

        [Input("value")]
        public Input<Inputs.ValueHttpValuePropertiesArgs>? Value { get; set; }
