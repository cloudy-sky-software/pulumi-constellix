...
{
    [ConstellixResourceType("constellix:templates:Caa")]
    public partial class Caa : global::Pulumi.CustomResource
    {
        /// <summary>
        ...
        /// </summary>
        [Output("mode")]
        public Output<CloudySkySoftware.Pulumi.Constellix.Templates.CaaPropertiesMode?> Mode { get; private set; } = null!;
        ...
        /// </summary>
        [Output("type")]
        public Output<CloudySkySoftware.Pulumi.Constellix.Templates.CaaPropertiesType?> Type { get; private set; } = null!;

        /// <summary>
        /// Standard record mode
        /// </summary>
        [Output("value")]
        public Output<ImmutableArray<Outputs.ValueCaaValueItemProperties>> Value { get; private set; } = null!;
        ...
        public Caa(string name, CaaArgs? args = null, CustomResourceOptions? options = null)
            : base("constellix:templates:Caa", name, args ?? new CaaArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Caa(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("constellix:templates:Caa", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static Caa Get(string name, Input<string> id, CustomResourceOptions? options = null)
        {
            return new Caa(name, id, options);
        }
    }

    public sealed class CaaArgs : global::Pulumi.ResourceArgs
    {
        [Input("contacts")]
        ...
        /// </summary>
        [Input("mode")]
        public Input<CloudySkySoftware.Pulumi.Constellix.Templates.CaaPropertiesMode>? Mode { get; set; }
        ...
        /// </summary>
        [Input("type")]
        public Input<CloudySkySoftware.Pulumi.Constellix.Templates.CaaPropertiesType>? Type { get; set; }

        [Input("value")]
        private InputList<Inputs.ValueCaaValueItemPropertiesArgs>? _value;

        /// <summary>
        /// Standard record mode
        /// </summary>
        public InputList<Inputs.ValueCaaValueItemPropertiesArgs> Value
        {
            get => _value ?? (_value = new InputList<Inputs.ValueCaaValueItemPropertiesArgs>());
            set => _value = value;
        }
        ...
        public static new CaaArgs Empty => new CaaArgs();
    }
}
