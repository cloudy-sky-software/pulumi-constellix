...
{
    [ConstellixResourceType("constellix:templates:Spf")]
    public partial class Spf : global::Pulumi.CustomResource
    {
        /// <summary>
        ...
        /// </summary>
        [Output("mode")]
        public Output<CloudySkySoftware.Pulumi.Constellix.Templates.SpfPropertiesMode?> Mode { get; private set; } = null!;
        ...
        /// </summary>
        [Output("type")]
        public Output<CloudySkySoftware.Pulumi.Constellix.Templates.SpfPropertiesType?> Type { get; private set; } = null!;

        /// <summary>
        /// Standard record mode
        /// </summary>
        [Output("value")]
        public Output<ImmutableArray<Outputs.ValueSpfValueItemProperties>> Value { get; private set; } = null!;


        /// <summary>
        /// Create a Spf resource with the given unique name, arguments, and options.
        /// </summary>
        ///
        /// <param name="name">The unique name of the resource</param>
        /// <param name="args">The arguments used to populate this resource's properties</param>
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public Spf(string name, SpfArgs? args = null, CustomResourceOptions? options = null)
            : base("constellix:templates:Spf", name, args ?? new SpfArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Spf(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("constellix:templates:Spf", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static Spf Get(string name, Input<string> id, CustomResourceOptions? options = null)
        {
            return new Spf(name, id, options);
        }
    }

    public sealed class SpfArgs : global::Pulumi.ResourceArgs
    {
        [Input("contacts")]
        ...
        /// </summary>
        [Input("mode")]
        public Input<CloudySkySoftware.Pulumi.Constellix.Templates.SpfPropertiesMode>? Mode { get; set; }
        ...
        /// </summary>
        [Input("type")]
        public Input<CloudySkySoftware.Pulumi.Constellix.Templates.SpfPropertiesType>? Type { get; set; }

        [Input("value")]
        private InputList<Inputs.ValueSpfValueItemPropertiesArgs>? _value;

        /// <summary>
        /// Standard record mode
        /// </summary>
        public InputList<Inputs.ValueSpfValueItemPropertiesArgs> Value
        {
            get => _value ?? (_value = new InputList<Inputs.ValueSpfValueItemPropertiesArgs>());
            set => _value = value;
        }
        ...
        public static new SpfArgs Empty => new SpfArgs();
    }
}
