...
{
    [ConstellixResourceType("constellix:templates:Srv")]
    public partial class Srv : global::Pulumi.CustomResource
    {
        /// <summary>
        ...
        /// </summary>
        [Output("mode")]
        public Output<CloudySkySoftware.Pulumi.Constellix.Templates.SrvPropertiesMode?> Mode { get; private set; } = null!;
        ...
        /// </summary>
        [Output("type")]
        public Output<CloudySkySoftware.Pulumi.Constellix.Templates.SrvPropertiesType?> Type { get; private set; } = null!;

        /// <summary>
        /// Standard record mode
        /// </summary>
        [Output("value")]
        public Output<ImmutableArray<Outputs.ValueSrvValueItemProperties>> Value { get; private set; } = null!;


        /// <summary>
        /// Create a Srv resource with the given unique name, arguments, and options.
        /// </summary>
        ///
        /// <param name="name">The unique name of the resource</param>
        /// <param name="args">The arguments used to populate this resource's properties</param>
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public Srv(string name, SrvArgs? args = null, CustomResourceOptions? options = null)
            : base("constellix:templates:Srv", name, args ?? new SrvArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Srv(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("constellix:templates:Srv", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static Srv Get(string name, Input<string> id, CustomResourceOptions? options = null)
        {
            return new Srv(name, id, options);
        }
    }

    public sealed class SrvArgs : global::Pulumi.ResourceArgs
    {
        [Input("contacts")]
        ...
        /// </summary>
        [Input("mode")]
        public Input<CloudySkySoftware.Pulumi.Constellix.Templates.SrvPropertiesMode>? Mode { get; set; }
        ...
        /// </summary>
        [Input("type")]
        public Input<CloudySkySoftware.Pulumi.Constellix.Templates.SrvPropertiesType>? Type { get; set; }

        [Input("value")]
        private InputList<Inputs.ValueSrvValueItemPropertiesArgs>? _value;

        /// <summary>
        /// Standard record mode
        /// </summary>
        public InputList<Inputs.ValueSrvValueItemPropertiesArgs> Value
        {
            get => _value ?? (_value = new InputList<Inputs.ValueSrvValueItemPropertiesArgs>());
            set => _value = value;
        }
        ...
        public static new SrvArgs Empty => new SrvArgs();
    }
}
