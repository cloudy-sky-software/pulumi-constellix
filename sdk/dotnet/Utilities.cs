...
namespace Pulumi.CONSTELLIX
{
    static class Utilities
    {
        ...
        public static global::Pulumi.InvokeOptions WithDefaults(this global::Pulumi.InvokeOptions? src)
        {
            ...
            dst.PluginDownloadURL = src?.PluginDownloadURL ?? "github://api.github.com/cloudy-sky-software/pulumi-constellix";
            return dst;
        }
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumi.CONSTELLIX.version.txt");
    ...
    internal sealed class CONSTELLIXResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public CONSTELLIXResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
